...
(async function loadProfile(){
  try{
    const r = await fetch(API_URL, {method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({action:'profile', empId:localStorage.getItem('empId'), token:localStorage.getItem('token')}) });
